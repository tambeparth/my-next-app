...
export default function HotelsPagesApiPage() {
  ...
  useEffect(() => {
    const fetchHotels = async () => {
      ...
      try {
        ...
        setDebugInfo(prev => ({
          ...prev,
          steps: [...prev.steps, 'Starting API call to pages/api endpoint']
        }));

        // Use our pages/api route
        const response = await axios.get(`/api/hotels?destination=${encodeURIComponent(destination)}`);
        
        setDebugInfo(prev => ({
          ...prev,
          steps: [...prev.steps, 'Pages API call successful'],
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">Hotels in {destination} (Pages API)</h1>
