...
# Define chat history
chat_history = [
    AIMessage(content="✈️ Welcome to your AI Travel Concierge!
...
HumanMessage(content="plannnnnnnnnnnnn"),
AIMessage(content="📅 3-Day Tokyo Experience:
...
HumanMessage(content="do planing"),
AIMessage(content="📅 3-Day Santorini Experience:
